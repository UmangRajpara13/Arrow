...
wget --show-progress -q -O ~/.local/share/nautilus-python/extensions/arrow-nautilus.py https://raw.githubusercontent.com/thevoyagingstar/Arrow/main/linux/arrow-nautilus.py
