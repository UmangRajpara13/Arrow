...
wget --show-progress -q -O ~/.local/share/nautilus-python/extensions/sonic-nautilus.py https://raw.githubusercontent.com/thevoyagingstar/Sonic/main/linux/sonic-nautilus.py
