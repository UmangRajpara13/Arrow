...
rm -f ~/.local/share/nautilus-python/extensions/combook-nautilus.py

# Download and install the extension
echo "Downloading newest version..."
wget --show-progress -q -O ~/.local/share/nautilus-python/extensions/combook-nautilus.py https://bitbucket.org/umangrajpara/combook-context/raw/478f4d4aebb98bd07150ee70a7669776e7f07007/combook-nautilus.py
